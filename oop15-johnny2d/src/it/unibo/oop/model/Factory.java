...
public class Factory {
	...
	public static class MainCharacterFactory {
		...
		/**
		 * Creates a {@link MainCharacter} centered in the {@link Rectangle} passed
		 * @return
		 */
		...
		/**
		 * Generates a {@link MainCharacter} with a movement {@link Vector2} defined
		 */
	...
	/**
	 * A {@link Factory} for the {@link InvisibleMonster} and the {@link BasicMonster}
	 */
	public static class EnemiesFactory {
		
		private EnemiesFactory() {}
		/**
		 * Generates a {@link BasicMonster} in a defined {@link Position} without a movement {@link Vector2}
		 */
		...
		/**
		 * Generates a {@link InvisibleMonster} in a defined {@link Position} without a movement {@link Vector2}
		 */
	...
	public static class BulletFactory {
		...
		/**
		 * Generates a {@link Bullet} with a starting {@link Vector2} and {@link Position}
		 */
